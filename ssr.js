...
const lesscssRaw = Object.keys(lesscss).map((key) => lesscss[key]).join(`
`);
const m = lesscssRaw.match(/@import (.*)/)
if ( m ) {
    throw new Error( 'DONOT use @imports in Vue components:' + m);
}
